...
class MdmModule extends Module
{
    /**
     * Constructor
     ...
     */
    function execute() {
        $GLOBALS['PluginManager']->triggerHook("server.plugin.mdmmodule.execute", array('moduleObject' =>& $this));
        return true;
    }
}
?>
