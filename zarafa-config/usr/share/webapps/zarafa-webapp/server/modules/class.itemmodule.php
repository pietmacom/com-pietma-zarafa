	...
	class ItemModule extends Module
	{
		...
		function copy($store, $parententryid, $entryids, $action)
		{
			...
			if($store && $parententryid && $entryids) {
				...
				$result = $GLOBALS["operations"]->copyMessages($store, $parententryid, $dest_store, $dest_folderentryid, $entryids, $moveMessages ? array() : $this->skipCopyProperties, $moveMessages);
